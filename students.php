...
$consulta2="SELECT user,img,lastname,email,id,cedula,carrera FROM login WHERE cedula LIKE '%$producto%'    AND rol='2' ORDER BY user ASC Limit 30;";
...
while($fila=mysqli_fetch_row($resultado2))
{
  ...
  echo "<p class='btn btn-dark' style='display:none;'>Año: ".$fila['4']."</p><p class='btn btn-dark float-sm-left'>Precio: ".$fila['6']."</p><br><button type='submit' class='btn btn-warning' style='display:none;'>"."Ver notas"."</button></div>";
