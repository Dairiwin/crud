...
echo '<li ><a class="dropdown-item" href="sedes.php">Incribirse</a></li><li><a class="dropdown-item"  href="desconectar.php"Cerrar sesion <span class="icon icon-switch"></span> </a></li>';
   }
